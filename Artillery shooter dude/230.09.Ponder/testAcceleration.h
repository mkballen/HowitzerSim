...
private:
   ...
   void add_zeroZero()
   {
      ...
      assertEquals(aRHS.getDDX(), 0.0);
      assertEquals(aRHS.getDDY(), 0.0);
   ...
   void add_valueZero()
   {
      ...
      Acceleration aRHS; // DDX and DDY = 0
   ...
   {
      //Setup
      Acceleration aLHS; // DDX and DDY = 0
      ...
      assertEquals(aRHS.getDDX(), 4.4);
      assertEquals(aRHS.getDDY(), 7.7);
   }
   ...
   {
      //Setup
      Acceleration aLHS(1.1, 2.2); // DDX and DDY = 0
      Acceleration aRHS(4.4, 7.7);
