...
private:
   ...
   void addV_stationary()
   {
      ...
      assertEquals(vRHS.getDX(), 2.3);
      assertEquals(vRHS.getDY(), 4.5);
   }
   ...
   void addV_nothing()
   {
      ...
      assertEquals(vLHS.getDX(), 2.3);
      assertEquals(vLHS.getDY(), 4.5);
      assertEquals(vRHS.getDX(), 0.0);
      assertEquals(vRHS.getDY(), 0.0);
   }
   ...
   void addV_moving()
   {
      ...
      assertEquals(vRHS.getDX(), 100.0);
      assertEquals(vRHS.getDY(), 200.0);
   }
