...
private:
   ...
   {
      double r = linearInterpolation(0.0, 0.0, 8.0, 8.0, 0.0);
      assertEquals(r, 0.0);
   }
   ...
   {
      double r = linearInterpolation(7.0, -3.0, 1.0, 9.0, 3.0);
      assertEquals(r, 5.0);
   }
   ...
   {  // setup
      ...
      // verify
      assertEquals(d, 0.0);
      assertEquals(r, -1.0); // the function returns -1 if it's too small
   }  // teardown
   ...
   {  // setup
      ...
      // verify
      assertEquals(d, 50.0);
      assertEquals(r, -2.0); // the function returns -2 if it's too big
   }  // teardown
