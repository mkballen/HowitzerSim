...
private:
   ...
   void getDx_down()
   {
      ...
      //Verify
      assertEquals(a.getDegrees(), 180.0);
      assertEquals(a.dX, 0);
   }
   ...
   void isRight_right()
   {
      ...
      //Excersize
      bool isItRight = a.isRight();

      // Verify
      assertEquals(a.getDegrees(), 30.0);
   ...
   void isRight_left()
   {
      ...
      // Verify
      assertEquals(a.getDegrees(), 330.0);
