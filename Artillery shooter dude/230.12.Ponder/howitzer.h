...
class Howitzer
{
   public:
      ...
      // default constructor
      Howitzer() : muzzleVelocity(DEFAULT_MUZZLE_VELOCITY), elevation(45.0), position(0.0, 0.0) {}
      Howitzer(double x, double y) : position(x, y) {}
      ...
      {
         double posPixX = posUpperRight.getPixelsX();
         double xPixels = random(posPixX * 0.1, posPixX * 0.9);
